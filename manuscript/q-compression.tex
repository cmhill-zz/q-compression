...
requirement.  For example, an additional third bin, thus giving bins
...
\textsc{QualComp}, in in our interpretation, appear to have no fixed
costs, and the marginal costs that are the product of the number of
