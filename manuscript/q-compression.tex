...
\caption{Mean squared error versus bits/base-call for different
  ...
  Bzip2, with the black asterisk corresponds to original uncompressed
  data.}
...
the figure.  The lossless compression of each data set using BZip2
...
0-degree polynomial regression, profile encodings, and QualComp have
...
uncompressed reads is QualComp with rate 100 bits/read, followed by
QualComp with rate 30 bits/read, 256-, and 128-profile encoding, then
2-bin encoding, 64-profile encoding, QualComp with rate 10 bits/read,
7th-degree polynomial regression, QualComp with rate 6 bits/read, and
...
QualComp with rate 100 bits/read results in the fewest missing
...
We thank the organizers and participants of the 2014 Bioinformatics
Exchange for Students and Teachers (BEST) Summer School, which was
funded by the offices of the Dean of The Graduate School at University
of Maryland and the Rektor of University of T\"{u}bingen.
