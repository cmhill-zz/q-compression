...
sequences. Furthermore, while lossless representation is necessary for
...
bad, and intermediate) can be used for base qualities near the border
...
$\sim$8.75 errors/100 kb of assembled sequence, while the 256-profile
