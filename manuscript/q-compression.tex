...
256-, 64-, 128-profile encoding had the highest ranks, followed by QualComp with rates 10 bits/read, 30 bits/read, 100 bits/read, then 7th-order polynomial regression, followed by the QualComp with rate 6 bits/read, the 2-bin encoding, and lastly, the 3rd-order, 5th-order, and 0-order polynomials.
...
In general, the greater the polynomial order, the better overall assembly; however, the 5th-order polynomial regression performs slightly worse than the 3rd-order polynomial.
Their respective ranks in terms of N50 and relocations are fairly distant, which lowers the 5th-order polynomial's overall ranking barely below the 3rd-order's.
The 1st- and 0-order polynomial regression methods perform poor in all metrics except assembled bases.
