...
the Supplemental Table 1. Storing the uncompressed quality
...
12,066 reads, respectively) (Supplemental Table 2).
...
Supplemental Table 3). Despite the similar contiguity statistics,
...
encoding has an error rate of 8.02 errors per 100 kbp (Supplemental
Table 3).
