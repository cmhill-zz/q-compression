...
respective end.
%uses a variable sliding window approach where base qualities are
%averaged over a window ($0.1 \times$ the read length) and trims from
%the position where the window's average quality falls below a given
