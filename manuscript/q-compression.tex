...
Ranking the compression methods by overall alignment rate produces an identical ordering as above.  Aside from 0-degree polynomial regression (83.1\%), all other compression methods have an alignment rate between 87\% and 86.1\%.
...
Setting all bases as minimum quality results in the highest fraction of mapped reads 88.1\%.
Conversely, setting all bases as maximum quality results in the lowest fraction of mapped reads 72.8\%.
...
\cline{2-12}
 & fraction & 1.000 & 0.000 & 0.000 & 1.000 & 0.851 & 0.149 & 0.712 & 0.288 & 0.859 & 0.141 \\ 
\end{tabular}
...
\cline{2-12}
& fraction & 0.860 & 0.140 & 0.867 & 0.133 & 0.865 & 0.135 & 0.870 & 0.130 & 0.873 & 0.127 \\ 
\end{tabular}
...
\cline{2-12}
& fraction & 0.875 & 0.125 & 0.870 & 0.130 & 0.870 & 0.130 & 0.871 & 0.129 & 0.867 & 0.133 \\ 
\end{tabular}
\end{table*}
...
& fraction & 0.728 & 0.272 & 0.881 & 0.119 & 0.870 & 0.130 & 0.831 & 0.169 & 0.862 & 0.138 \\ 
\end{tabular}
...
& fraction & 0.868 & 0.132 & 0.869 & 0.131 & 0.870 & 0.130 & 0.870 & 0.130 & 0.870 & 0.130 \\ 
\end{tabular}
...
& fraction & 0.870 & 0.130 & 0.870 & 0.130 & 0.870 & 0.130 & 0.870 & 0.130 & 0.870 & 0.130 \\
