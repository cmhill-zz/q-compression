...
representing these positions. It should be noted that the fixed costs
of the dictionary of commonly occurring $k$-mers can be amortized over
reads for which the dictionary may be appropriately used (e.g., reads
