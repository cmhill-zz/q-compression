...
\author[
   ...
   %noteref={n1},                        % id's of article notes, if any
   %email={}   % email address
]{\inits{MH}\fnm{Mohamed} \snm{El Hadidi}}
\author[
   addressref={aff4},
   corref={aff4},
...
\address[id=aff2]{%
  \orgname{Department of Applied Bioinformatics, Center for Bioinformatics, Quantitative Biology Center, and Department of Computer Science, University of T\"{u}bingen},
  \street{Sand 14},
  \postcode{72076},
  \city{T\"{u}bingen},
  \cny{Germany}
...
\address[id=aff3]{%
  \orgname{Department of Algorithms in Bioinformatics, Center for Bioinformatics, University of T\"{u}bingen},
  \street{Sand 14},
  \postcode{72076},
  \city{T\"{u}bingen},
  \cny{Germany}
...
\address[id=aff4]{%                           % unique id
  \orgname{Center for Bioinformatics and Computational Biology, University of Maryland},                  %
...
\bibliography{compression.bib}      % Bibliography file (usually '*.bib' )
...
\section*{Figures}
  ...
  Quality profiles obtained by $k$-means clustering on the
...
\begin{figure}[h!]
  ...
  \caption{\csentence{The relationship of bits/base-call and mean squared error for quality value compression methods applied to four data sets:
...
\begin{figure}[h!]
  ...
  \caption{\csentence{Preprocessing results of \textit{Rhodobacter sphaeroides}
...
\begin{figure}[h!]
  ...
  \caption{\csentence{Rankings of compression methods based on \textit{Rhodobacter
